...
const NewsLetter = () => {
  return (
    <div>
         <div className="flex flex-col items-centerl max-w-5xl lg:w-full rounded-2xl 
           ...
           <Title  title="Stay Inspired" subTitle="Join our newsletter and be the first to discover new
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6">
                ...
                <button className="flex items-center justify-center gap-2 group bg-black px-4 md:px-7 py-2.5 rounded active:scale-95 transition-all">Subscribe
                    <img src={assets.arrowIcon} alt="arrow-icon" className="w-4 invert group-hover:translate-x-1 transition-all" />
                </button>
            </div>
