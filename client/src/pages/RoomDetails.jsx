      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col lg:flex-row mt-6 gap-6">
          ...
          <div className="grid grid-cols-2 gap-4 lg:w-1/2 w-full">
            ...
            {/* Room HighLights */}
         <div className='flex flex-col md:flex-row md: justify-betwwenn mt-10'>
         <div className='flex flex-col'>
          <h1 className='text-3xl md:text-4xl font-playfair'>Experience Luxuxry
         ...
         <p className='absolute  right-0 mr-35 text-2xl font-medium'>${room.pricePerNight}/night</p>
