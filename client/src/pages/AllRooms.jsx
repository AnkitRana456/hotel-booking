    ...
    justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Take advantage of our limited-time offers and special packages to enhance your stay
                ans create unforgettable memories.</p>
            </div>

          {roomsDummyData.map((room) => (
             <div className='flex flex-col md:flex-row items-start gap-6 
             py-10 border-b border-gray-300 last:pb-30 last:border-0' key={room.id}   >
                <img onClick ={() => {navigate(`/rooms/${room._id}`); scrollTo(0,0)}}
                 key={room.id} 
                 srcSet={`${room.images[0]} 2x`}
                 ...
                 <div className='md:w-1/2 flex flex-col gap-2'>
                    <p className='text-gray-500'>{room.hotel.city}</p>
                     ...
                     <div>
                        ...
                        <p className='text-xl medium text-gray-800'>
        ...
        <div className='bg-white w-80 border border-gray-300
         text-gray-600 max-lg:mb-8 min-lg:mt-16'>
              <div className={`flex items-center justify-between px-5 py-2.5 min-lg:border-b border-gray-300 ${openFilters && "border-b"}`}>
                <p className='text-base font-meium text-gray-800'>FILTERS</p>
              ...
              <div className={`${openFilters ? 'h-auto' : 'h-0 lg:h-auto'}
               ...
               <div className='px-5 pt-5'>
                <p className='font-medium text-gray-800 pb-2'>Popoular filters</p>
